...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/isce3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/isce3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add isce3 isce3-cpu isce3-cuda
# for installing globally
pixi global install isce3 isce3-cpu isce3-cuda
```
...
It is possible to list all of the versions of `isce3` available on your platform:
...
```
pixi search isce3 --channel conda-forge
```
...
* [@jplzhan](https://github.com/jplzhan/)
